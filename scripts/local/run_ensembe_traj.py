...
files = glob.glob("/home/ian/Documents/Data/MD_LV_paper_data/inits/equil_*hertz*")
...
for i, f in enumerate(files):
    ...
    for temp in temps:
        ...
        command = f'/home/ian/Documents/Projects/md-lv/target/release/md-lv --unwrap --potential hertz --time 10000.0 \
            --init-config {f} --temp {temp} --seed {200000+i} --dt 1e-2 --out-time 1e-2 \
            --dir /home/ian/Documents/Data/MD_LV_paper_data/small_find_glass_transition \
            gen-variant --realizations 1 --del-var=0.0 --calc-msd --calc-pos --calc-q={as_str}'
